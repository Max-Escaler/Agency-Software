...
INSERT INTO tbl_db_revision_history 
	...
	changed_by
	 ...
	 VALUES (
		'ARRAY_UNIQUE_ONE_NULL', /*UNIQUE_DB_MOD_NAME */
		'Make Postress array_unique function return at most one NULL value',
		'AGENCY_CORE', /* Which flavor of AGENCY.  AGENCY_CORE applies to all installations */
		'', /* git SHA ID, if applicable */
		'db_mod.77', /* git tag, if applicable */
		current_timestamp, /* Applied at */
		'', /* comment */
		sys_user(),
		sys_user()
	 );
\cd ../agency_core/functions
\i create.functions_array.sql
\cd ../../db_mods
